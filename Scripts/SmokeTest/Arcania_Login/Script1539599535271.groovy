...
WebUI.setText(findTestObject('Page_Arcania - Log In/input_Username'), varUsername)

WebUI.setEncryptedText(findTestObject('Page_Arcania - Log In/input_Password'), varPassword)
