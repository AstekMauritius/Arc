...
WebUI.verifyElementPresent(findTestObject('AgentLead_Edit/Page_Arcania - Leads/Page_Arcania - Leads/li_Indian oil'), 10)

WebUI.click(findTestObject('AgentLead_Edit/Page_Arcania - Leads/Page_Arcania - Leads/li_Indian oil'), FailureHandling.STOP_ON_FAILURE)
