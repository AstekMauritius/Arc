...
WebUI.click(findTestObject('Page_Arcania - Dashboard/Icon_Leads'))
...
WebUI.click(findTestObject('PrivateLead_Transfer/Page_Arcania - Lead Detail/PrivateLeadTransferOption'))

WebUI.click(findTestObject('PrivateLead_Transfer/Page_Arcania - Lead Detail/label_AGS Aruba'))

WebUI.click(findTestObject('PrivateLead_Transfer/Page_Arcania - Lead Detail/SubmitBtn'))
